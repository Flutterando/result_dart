...
extension ResultSuccessObjectExtension<W extends Object> on W {
...
extension ResultFailureObjectExtension<W extends Exception> on W {
  /// Convert the object to a `Result` type [Failure].
  ///
  /// Will throw an error if used on a `Result` or `Future` instance.
  Failure<S> toFailure<S extends Exception>() {
    assert(
      this is! Result,
